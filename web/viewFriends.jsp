  ...
  <head>
      ...
      <script>
            ...
            function unfriend(fid,btn){
                ...
                xmlhttp.open("POST","./unfriendServlet", true);
    ...
    <h1 class="heading my-3">Your Friends</h1>
    
    <section style="max-width: 800px; margin: 0 auto; margin-bottom: 20%">
    <%  
        try{
            ResultSet rs = DBLoader.executeSQl("select * from friends where requestfrom='"+sessionusername.toString()+"' and status='friends'");
                            ...
                            <div class="card shadow my-4 mx-3">
                                <div class="row align-items-center px-3 py-3 py-md-2 justify-content-center justify-content-md-start">
                                  ...
                                  <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-end d-flex mt-2">
                                    <button class="btn mx-3 btn-danger btn-lg" onclick="unfriend(<%=fid%>,this)">Unfriend</button>
                                  </div>
                                </div>
                            </div>
